    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto" data-lenis-prevent>
        ...
        <motion.div
          ...
          className="relative w-full max-w-5xl bg-white rounded-[2rem] shadow-2xl overflow-hidden my-8"
        >
          {/* Header */}
          <div className={`p-8 md:p-12 ${category.bgClass} relative overflow-hidden`}>
            ...
            <h2 className="relative z-10 text-3xl md:text-5xl font-display font-black text-white">{category.title}</h2>
          </div>

          {/* Content Body - Scrollable */}
          <div className="p-8 md:p-12 max-h-[70vh] overflow-y-auto custom-scrollbar bg-slate-50" data-lenis-prevent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                     ...
                     <div className="space-y-8">
                       <div>
                         ...
                         <p className="font-sans text-slate-600 leading-relaxed bg-red-50/50 p-6 rounded-2xl border border-red-100">
                           {cs.problem}
                         </p>
                       </div>
                     ...
                     <div className="space-y-8">
                        <div>
                         ...
                         <p className="font-sans text-slate-600 leading-relaxed bg-blue-50/50 p-6 rounded-2xl border border-blue-100">
                           {cs.solution}
                         </p>
                       </div>
                       ...
                       <div className={`mt-auto p-6 rounded-2xl border ${category.resultBgClass} ${category.resultBorderClass}`}>
            ...
            <div className="mt-12 text-center">
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className={`inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full font-bold text-white transition-all hover:scale-105 shadow-lg ${category.bgClass} hover:opacity-90`}
              >
